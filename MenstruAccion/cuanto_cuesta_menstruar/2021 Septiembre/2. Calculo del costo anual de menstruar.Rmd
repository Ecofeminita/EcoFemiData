...
<font size="6"> Toallitas: El precio promedio por unidad es de $`r round(gasto_por_anio_toallitas, 2)` </font> 
...
<font size="6"> Toallitas: El precio promedio por unidad es de $`r round(valor_tampones, 2)` </font> 
...
<font size="6"> Toallitas: El precio promedio por unidad es de $`r round(gasto_por_anio_tampones, 2)` </font> 
