...
datos <- read.csv("Fuentes/precios-gestion-menstrual-2025-03-10.csv", 
                  header = TRUE, sep = ",", dec = ".", 
...
```{r echo=TRUE}
saveRDS(datos, file = "Fuentes/precios-gestion-menstrual-2025-03-10-limpio.RDS")
```