...
subtitle: Datos de Septiembre 2025
output:
  html_document:
    toc: no
    toc_depth: '5'
...
datos <- readRDS("Fuentes/precios-gestion-menstrual-2025-09-17-limpio.RDS")
...
ggplot(base100bis, aes(x = Mes, y = Indice, group = Categoria, color = Categoria)) +
  ...
  expand_limits(x = as.POSIXct(c("2019-03-01", "2025-09-01"))) + 
  labs(title = "Inflación de Toallitas y Tampones vs. Salud y Nivel General del IPC-INDEC",
       subtitle = "Marzo 2019 - Septiembre 2025", #<------------------------------------------------- CAMBIAR
       x = "",
       y = "Indice de precios",
