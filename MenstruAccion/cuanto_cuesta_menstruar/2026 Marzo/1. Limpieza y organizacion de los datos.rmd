...
author: "Datos de Septiembre 2025"
output:
  html_document:
    toc: no
    toc_depth: '5'
...
datos <- read.csv("Fuentes/precios-gestion-menstrual-2026-04-01.csv", 
                  header = TRUE, sep = ",", dec = ".", 
...
datos <- datos %>% 
  filter(Precio.de.lista < 6000) #saco los outliers mayores a 3000 porque son demasiado altos. 
...
```{r echo=TRUE}
saveRDS(datos, file = "Fuentes/precios-gestion-menstrual-2026-04-01-limpio.RDS")
```