...
```{r echo=FALSE, message=FALSE, warning=FALSE}
individual <- get_microdata(year = 2019, trimester = 4, type = 'individual')
hogar <- get_microdata(year = 2019, trimester = 4, type = 'hogar')
```
...
De acuerdo al ejercicio de Marzo 2020:   

```{r echo=FALSE, message=FALSE, warning=FALSE}
gasto_toallitas <- 2933
gasto_tampones <- 3782
```
