...
server = function(input, output,session) {
  ...
  observeEvent(input$boton2, {
    output$texto1 <- renderText({"Para aquellas personas que no pueden adquirir los medios para comprar estos productos, la menstruación será un factor de ausentismo escolar y laboral. En nuestro país, <b> siete de cada diez personas del grupo poblacional de menores ingresos son mujeres,</b> por lo que el gasto en productos de gestión menstrual recae sobre un gran grupo de la población que particularmente enfrenta una situación desventajosa."
      })
