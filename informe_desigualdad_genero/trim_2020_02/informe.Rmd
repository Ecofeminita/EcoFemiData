...
<br><br>
^3^ Natsumi Shokida es economista (FCE-UBA) y maestranda en Información y Ciencias de la Computación en la Universidad de Luxemburgo. Coordinadora de EcoFemiData, el área de datos de [Economía Femini(s)ta](http://economiafeminita.com).
<br><br>
^4^ Presionando en_  __Code > Download Rmd__ _se accede a la descarga de la sintaxis completa de este informe.
<br><br>
^5^ Si necesitás citarnos en un trabajo, podés hacerlo como: "Moure, J.; Serpa, D.; Shokida, N. (XX/XX/2020) La desigualdad de género se puede medir. `r date`. _Economía Femini(s)ta_. Recuperado de https://ecofeminita.github.io/EcoFemiData/informe_desigualdad_genero/trim_2020_02/informe.nb.html"
