...
<br><br>
^2^ Si necesitás citarnos en un trabajo, podés hacerlo como: "Moure, J.; Serpa, D.; Shokida, N. (XX/XX/XXXX) La desigualdad de género se puede medir. `r date`. _EcoFeminita_. Recuperado de https://ecofeminita.github.io/EcoFemiData/informe_desigualdad_genero/trim_2020_02/informe.nb.html"
...
__Figura 6.__
<br>
<p style="color:#E5616E">__Indicadores por ramas de la ocupación__</p>
```{r echo=FALSE, message=FALSE, warning=FALSE}
tabla6 %>% 
  kable(align = 'lrrr', 
