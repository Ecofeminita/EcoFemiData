...
inline_4 <- tabla1.4.v$`de 14 a 29 años`[tabla1.4.m$Indicadores == "Tasa Desocupación"]
...
inline_5 <- tabla2.1$`Sin descuento jubilatorio`[tabla2.1$Sexo == "Mujeres"]
inline_6 <- tabla2.1$`Sin descuento jubilatorio`[tabla2.1$Sexo == "Varones"]
```
...
inline_7 <- formato_porc((tabla3.1$proporcion[tabla3.1$JERARQUIA %in% c("Dirección o Jefes") & tabla3.1$Sexo == "Varones"]) * 100)
inline_8 <- formato_porc((tabla3.1$proporcion[tabla3.1$JERARQUIA %in% c("Dirección o Jefes") & tabla3.1$Sexo == "Mujeres"]) * 100)
```
