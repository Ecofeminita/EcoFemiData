...
tabla6 <- base_individual %>% 
  ...
  transmute("Rama de la ocupación" = Rama,
         ...
         "Ingreso mensual promedio" = formato_pesos(ingreso_promedio),
         "Ingreso horario" = formato_pesos(ingreso_hor))
```
...
inline_9 <- tabla4.6$`Brecha`[tabla4.6$Población == "Perceptores de ingresos"]
inline_10 <- tabla4.6$`Brecha`[tabla4.6$Población == "Ocupadas/os"]

inline_11 <- tabla4.6$`Mujeres`[tabla4.6$Población == "Ocupadas/os"]
inline_12 <- tabla4.6$`Varones`[tabla4.6$Población == "Ocupadas/os"]

inline_13 <- tabla4.6$`Brecha`[tabla4.6$Población == "Asalariadas/os sin desc. jubil."]
...
inline_14 <- formato_pesos(tabla5.1$IOP_mensual[tabla5.1$Sexo == "Varones" & tabla5.1$CALIFICACION == "Profesionales"], dec = 0) 

inline_15 <- formato_pesos(tabla5.1$IOP_mensual[tabla5.1$Sexo == "Mujeres" & tabla5.1$CALIFICACION == "Profesionales"], dec = 0)
