...
tabla6 <- base_individual %>% 
  ...
  transmute("Rama de la ocupación" = Rama,
            ...
            "Ingreso mensual promedio" = formato_pesos(round(ingreso_promedio, -2)),
            "Ingreso horario" = formato_pesos(round(ingreso_hor)))
```
...
tabla7 <- bind_rows(tabla7.1, tabla7.2, tabla7.3, tabla7.4) %>% 
  mutate(Brecha = percent(((Varones-Mujeres)/Varones), 1),
         Mujeres = formato_pesos(round(Mujeres, -2)),
         Varones = formato_pesos(round(Varones, -2))) %>% 
...
rm(tabla7, tabla7.1, tabla7.2, tabla7.3, tabla7.4, 
   inline_9, inline_10, inline_11, inline_12, inline_13)
```
