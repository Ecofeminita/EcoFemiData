...
author: "Julieta Moure^1^, Daiana Serpa^2^, Natsumi Shokida^3^ para EcoFeminita"
date: "Junio de 2020"
output:
  html_notebook:
    theme: flatly
...
<br><br>
El documento se realizó utilizando el lenguaje de programación R, y para les curioses todo el código se encuentra disponible para su descarga^4^. 
<br><br>
Obviamente, estás invitade a utilizar estos datos en notas, reflexiones, trabajos, infografías, etc^5^. Además, si te gusta lo que hacemos podés apoyarnos potenciando nuestros proyectos, haciéndote socie del [#ClubEcofeminita o realizando una donación](https://donaronline.org/economia-femini-s-ta/club-ecofeminita).
...
<br><br>
^3^ Natsumi Shokida es economista (FCE-UBA), coordinadora de EcoFemiData, el área de datos de [EcoFeminita](http://ecofeminita.com).
<br><br>
...
<br><br>
^5^ Si necesitás citarnos en un trabajo, podés hacerlo como: "Moure, J.; Serpa, D.; Shokida, N. (XX/XX/2020) La desigualdad de género se puede medir. `r date`. _EcoFeminita_. Recuperado de https://ecofeminita.github.io/EcoFemiData/informe_desigualdad_genero/trim_2019_04/informe.nb.html"
