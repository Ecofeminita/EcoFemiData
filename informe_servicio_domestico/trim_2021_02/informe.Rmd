...
subtitle: "2do trimestre de 2021"
author: "#EcoFemiData, equipo de datos de Ecofeminita - Noviembre de 2021"
output: 
  html_notebook:
    theme: flatly
urlcolor: #E5616E
...
base_individual <- eph::get_microdata(year = 2021, trimester = 2, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2021, trimester = 2, type =  "hogar")           # <-----------------
```
...
<p style="color:#E5616E">__Trabajadoras de servicio domeśtico según deciles de ingreso de la ocupación principal__</p> 
```{r echo=FALSE, message=FALSE, warning=FALSE}
