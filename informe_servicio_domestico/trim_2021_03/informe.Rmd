...
subtitle: "3er trimestre de 2021"
author: "#EcoFemiData, equipo de datos de Ecofeminita - Febrero de 2021"
output: 
  html_notebook:
    theme: flatly
urlcolor: #E5616E
...
base_individual <- eph::get_microdata(year = 2021, trimester = 3, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2021, trimester = 3, type =  "hogar")           # <-----------------
```
...
tabla6a <- serv.dom %>% 
  summarise("Ingreso promedio" = weighted.mean(IPCF, PONDIH, na.rm = TRUE), 
