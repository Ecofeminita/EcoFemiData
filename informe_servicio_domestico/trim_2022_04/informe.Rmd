...
date <- as.character("4to trimestre de 2022")                        # <-----------------
...
base_individual <- eph::get_microdata(year = 2022, trimester = 4, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2022, trimester = 4, type =  "hogar")           # <-----------------
```
