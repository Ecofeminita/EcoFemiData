...
subtitle: "4to trimestre de 2020"
author: "#EcoFemiData, equipo de datos de Economía Feminita - Junio de 2021"
output: 
  html_notebook:
    theme: flatly
urlcolor: #E5616E
...
base_individual <- eph::get_microdata(year = 2020, trimester = 4, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2020, trimester = 4, type =  "hogar")           # <-----------------
```
...
<p style="color:#E5616E">__Trabajadoras de servicio domśtico según deciles de ingreso de la ocupación principal__</p> 
```{r echo=FALSE, message=FALSE, warning=FALSE}
