...
date <- as.character("1er trimestre de 2024")                        # <-----------------
...
base_individual <- eph::get_microdata(year = 2024, trimester = 1, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2024, trimester = 1, type =  "hogar")           # <-----------------
```
