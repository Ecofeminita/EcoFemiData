...
date <- as.character("2do trimestre de 2023")                        # <-----------------
...
base_individual <- eph::get_microdata(year = 2023, trimester = 2, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2023, trimester = 2, type =  "hogar")           # <-----------------
```
