...
subtitle: "4to trimestre de 2021"
author: "#EcoFemiData, equipo de datos de Ecofeminita - Mayo de 2022"
output: 
  html_notebook:
    theme: flatly
urlcolor: #E5616E
...
base_individual <- eph::get_microdata(year = 2021, trimester = 4, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2021, trimester = 4, type =  "hogar")           # <-----------------
```
