...
date <- as.character("4to trimestre de 2023")                        # <-----------------
...
base_individual <- eph::get_microdata(year = 2023, trimester = 4, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2023, trimester = 4, type =  "hogar")           # <-----------------
```
