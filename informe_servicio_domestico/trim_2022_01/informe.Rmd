...
author: '#EcoFemiData, equipo de datos de Ecofeminita - Septiembre de 2022'
subtitle: 1er trimestre de 2022
output:
  html_document:
    df_print: paged
  html_notebook:
...
date <- as.character("1er trimestre de 2022")                        # <-----------------
...
base_individual <- eph::get_microdata(year = 2022, trimester = 1, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2022, trimester = 1, type =  "hogar")           # <-----------------
```
