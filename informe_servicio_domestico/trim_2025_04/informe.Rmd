...
date <- as.character("4to trimestre de 2025")                        # <-----------------
...
base_individual <- eph::get_microdata(year = 2025, trimester = 4, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2025, trimester = 4, type =  "hogar")           # <-----------------
```
