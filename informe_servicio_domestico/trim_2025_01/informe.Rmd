...
date <- as.character("1er trimestre de 2025")                        # <-----------------
...
base_individual <- eph::get_microdata(year = 2025, trimester = 1, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2025, trimester = 1, type =  "hogar")           # <-----------------
```
