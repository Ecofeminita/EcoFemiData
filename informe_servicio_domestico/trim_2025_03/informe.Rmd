...
date <- as.character("3er trimestre de 2025")                        # <-----------------
...
base_individual <- eph::get_microdata(year = 2025, trimester = 3, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2025, trimester = 3, type =  "hogar")           # <-----------------
```
