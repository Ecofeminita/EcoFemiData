...
date <- as.character("1er trimestre de 2023")                        # <-----------------
...
base_individual <- eph::get_microdata(year = 2023, trimester = 1, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2023, trimester = 1, type =  "hogar")           # <-----------------
```
...
serv.dom %>% 
  ...
  labs(caption = "Fuente: Natsumi Shokida en base a EPH-INDEC") +
  theme_minimal() +
