...
date <- as.character("2do trimestre de 2022")                        # <-----------------
...
base_individual <- eph::get_microdata(year = 2022, trimester = 2, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2022, trimester = 2, type =  "hogar")           # <-----------------
```
