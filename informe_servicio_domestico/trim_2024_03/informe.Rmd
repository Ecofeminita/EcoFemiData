...
date <- as.character("3er trimestre de 2024")                        # <-----------------
...
base_individual <- eph::get_microdata(year = 2024, trimester = 3, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2024, trimester = 3, type =  "hogar")           # <-----------------
```
