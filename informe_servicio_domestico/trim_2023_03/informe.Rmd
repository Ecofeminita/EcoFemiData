...
date <- as.character("3er trimestre de 2023")                        # <-----------------
...
base_individual <- eph::get_microdata(year = 2023, trimester = 3, type =  "individual") # <-----------------
base_hogar <- eph::get_microdata(year = 2023, trimester = 3, type =  "hogar")           # <-----------------
```
